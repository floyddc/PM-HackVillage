...
L'obiettivo di HackVillage è centralizzare in un'unica piattaforma tutte le principali attività legate a un hackathon:
- Gestione degli eventi.
- Registrazione dei partecipanti.
- Formazione dei team.
- Assegnazione dei mentor.
- Raccolta delle submission.
