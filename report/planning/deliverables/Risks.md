...
| **R3** | **Cambiamenti improvvisi di mercato** | Scopo/Qualità | Minima | Alta | **Accept** | Vista la *Market analysis* iniziale (trend hackathon in forte crescita) una contrazione improvvisa della domanda è considerata quasi impossibile. Rischio accettato passivamente senza allocazione di budget o modifiche all'ambito. |
